...
function initGL() {
    ...
    surface.iTextureDiffuse = LoadTexture("surfaceTextures/diffuse.jpg");
    surface.iTextureSpecular = LoadTexture("surfaceTextures/specular.jpg");
    surface.iTextureNormal = LoadTexture("surfaceTextures/normal.jpg");
